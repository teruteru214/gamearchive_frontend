  ...
  return (
    <Container>
      <div className="px-8 py-5">
        ...
        <Divider mt="lg" mb={50} />
        <Text>
          GameArchive（以下、「当方」といいます。）は、本ウェブサイト上で提供するサービス（以下、「本サービス」といいます。）におけるユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます。）を定めます。
        </Text>
        <Space h={50} />
        <article className="prose prose-sm max-w-none">
          ...
          <span>
            Xアカウント:
            <a
              href="https://twitter.com/teruteru1237"
              target="_blank"
              rel="noreferrer"
            >
              https://twitter.com/teruteru1237
            </a>
          </span>
          <br />
          <br />
